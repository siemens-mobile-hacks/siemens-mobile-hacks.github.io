...
- **[x65PapuaUtils](./x65-papua-utils.md)**<br/>
  Service utility for diagnostics and recovery of Siemens phones on the SGOLD platform.
...
- **[GetMaster](./getmaster.md)**<br/>
  Calculating the master code of Siemens x65 phones from the IMEI and EEPROM block 5121.
- **[MAP65](./map65.md)**<br/>
  Reading and writing standard and delta MAP in Siemens x65 phones.
